...
32.4.3-jetpack-4.4: 32.4.3-jax-jetpack-4.4 32.4.3-jax-8gb-jetpack-4.4 32.4.3-nano-jetpack-4.4 32.4.3-nano-dev-jetpack-4.4 32.4.3-tx1-jetpack-4.4 32.4.3-tx2-jetpack-4.4 32.4.3-tx2i-jetpack-4.4 32.4.3-tx2-4gb-jetpack-4.4 32.4.3-nx-jetpack-4.4 32.4.3-nx-dev-jetpack-4.4 
...
32.4.3-jax-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-jax-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-jax-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-jax-jetpack-4.4-deps"
...
32.4.3-jax-8gb-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-jax-8gb-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-jax-8gb-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-jax-8gb-jetpack-4.4-deps"
...
32.4.3-nano-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-nano-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-nano-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-nano-jetpack-4.4-deps"
...
32.4.3-nano-dev-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-nano-dev-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-nano-dev-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-nano-dev-jetpack-4.4-deps"
...
32.4.3-tx1-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-tx1-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-tx1-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-tx1-jetpack-4.4-deps"
...
32.4.3-tx2-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-tx2-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-tx2-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-tx2-jetpack-4.4-deps"
...
32.4.3-tx2i-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-tx2i-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-tx2i-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-tx2i-jetpack-4.4-deps"
...
32.4.3-tx2-4gb-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-tx2-4gb-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-tx2-4gb-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-tx2-4gb-jetpack-4.4-deps"
...
32.4.3-nx-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-nx-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-nx-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-nx-jetpack-4.4-deps"
...
32.4.3-nx-dev-jetpack-4.4-deepstream:
	-($(DOCKER) run $(DOCKER_RUN_ARGS) $(REPO):32.4.3-nx-dev-jetpack-4.4-deps /bin/bash -c "[ -f /data/deepstream*arm64.deb ]") && \
	[ $$? -eq 0 ] && \
	$(DOCKER) build $(DOCKER_DEPS_IMAGE_BUILD_ARGS) \
					--build-arg IMAGE_NAME=$(IMAGE_NAME) \
					--build-arg DEPENDENCIES_IMAGE=$(REPO):32.4.3-nx-dev-jetpack-4.4-deps \
	...
	|| echo "Skipping: DeeepStream was not found in the dependencies image: $(REPO):32.4.3-nx-dev-jetpack-4.4-deps"
